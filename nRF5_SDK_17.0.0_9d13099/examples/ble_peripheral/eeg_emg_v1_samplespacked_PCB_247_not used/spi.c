...
static uint8_t               m_spi_ss_pins[NUM_MAX30003_DEVS] = { MAX30003_SPI_DEV0_SS_PIN, MAX30003_SPI_DEV1_SS_PIN };
...
ret_code_t spi_init()
{
    ...
    spi_config.miso_pin       = MAX30003_SPI_MISO_PIN;
    spi_config.mosi_pin       = MAX30003_SPI_MOSI_PIN;
    spi_config.sck_pin        = MAX30003_SPI_SCK_PIN;
    spi_config.ss_active_high = false;
    spi_config.mode           = NRF_SPIM_MODE_0;

    ret = nrfx_spim_init(&m_spi, &spi_config, spim_event_handler, NULL);

    for (instance_id=0; instance_id < NUM_MAX30003_DEVS; instance_id++)
    {
